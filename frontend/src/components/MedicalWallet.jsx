                        ...
                        <div ref={cardRef} style={{
                            ...
                            <div style={{ background: 'linear-gradient(135deg, #022c22 0%, #064e3b 100%)', padding: '22px 24px 18px', position: 'relative', overflow: 'hidden' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
                                        <div style={{ width: 32, height: 32, borderRadius: 9, background: 'linear-gradient(135deg, #10b981, #06b6d4)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, fontSize: 16, color: '#fff' }}>M</div>
                                        <div>
                                            <p style={{ color: '#eef0ff', fontWeight: 800, fontSize: 13, margin: 0 }}>MedMap AI</p>
                            ...
                            <div style={{ background: '#f8fafc', padding: '18px 24px 20px' }}>
                                ...
                                <div style={{ marginTop: 16, paddingTop: 12, borderTop: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <p style={{ fontSize: 9, color: '#cbd5e1', margin: 0 }}>Generated by MedMap AI · For reference only · Not a substitute for medical advice</p>
